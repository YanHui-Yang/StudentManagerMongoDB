    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" id="courseName" name="courseName" value="${course.courseName}" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">课时</label>
            <div class="layui-input-block">
                <input type="text" id="courseHour" name="courseHour" value="${course.courseHour}" class="layui-input">
            </div>
        </div>
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/course?method=update",
