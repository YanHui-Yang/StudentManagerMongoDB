                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="courseName" name="courseName" autocomplete="off"
                                       placeholder="请输入课程名称" value="" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/course?method=findAll',
            toolbar: '#toolbarDemo',
            ...
            cols: [[
                ...
                {field: 'courseHour', title: '课时', minWidth: 100, align: "center"},
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {  // 监听添加操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '${pageContext.request.contextPath}/page?forward=addCourse',
                });
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '${pageContext.request.contextPath}/page?forward=editCourse&id=' + data._id,
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                layer.confirm('真的删除行么', function (index) {
                    $.ajax({
                        url: '${pageContext.request.contextPath}/course?method=delete',
                        type: "post",
                        dataType: "json",
