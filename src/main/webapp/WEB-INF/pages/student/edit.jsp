        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="deptName" class="" id="deptName">
                    <option value="${student.deptName}">${student.deptName}</option>
                </select>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="majorName" class="" id="majorName">
                    <option value="${student.majorName}">${student.majorName}</option>
                </select>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <select name="clazzName" class="" id="clazzName">
                    <option value="${student.clazzName}">${student.clazzName}</option>
                </select>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" id="stuNumber" name="stuNumber" value="${student.stuNumber}" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">姓名</label>
            <div class="layui-input-block">
                <input type="text" id="stuName" name="stuName" value="${student.stuName}" class="layui-input">
            </div>
        </div>
