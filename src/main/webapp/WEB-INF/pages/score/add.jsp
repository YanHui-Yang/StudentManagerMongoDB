...
<div class="layui-form layuimini-form">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="stuName" name="stuName" placeholder="请输入学生姓名" value="" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" id="score" name="score" placeholder="请输入成绩" value="" class="layui-input">
        </div>
    </div>
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.ajax({
                type: "post",
                url: "${pageContext.request.contextPath}/score?method=insert",
