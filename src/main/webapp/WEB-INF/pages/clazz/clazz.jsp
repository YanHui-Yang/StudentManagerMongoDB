                ...
                <form class="layui-form layui-form-pane" action="">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="clazzName" name="clazzName" autocomplete="off" placeholder="请输入班级编号" value="" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
        ...
        table.on('toolbar(currentTableFilter)', function (obj) {
            if (obj.event === 'add') {  // 监听添加操作
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '${pageContext.request.contextPath}/page?forward=addClazz',
                });
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['100%', '100%'],
                    content: '${pageContext.request.contextPath}/page?forward=editClazz&id=' + data._id,
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                layer.confirm('真的删除行么', function (index) {
                    $.ajax({
                        url: '${pageContext.request.contextPath}/clazz?method=delete',
                        type: "post",
                        dataType: "json",
